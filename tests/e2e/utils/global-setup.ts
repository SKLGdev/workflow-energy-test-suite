...
export default async function globalSetup(config: FullConfig) {
  ...
  const usuarios = [
    { rol: 'admin', email: process.env.ADMIN_USER, password: process.env.ADMIN_PASS, archivo: 'adminAuth.json' },
    { rol: 'supervisor', email: process.env.SUPERVISOR_USER, password: process.env.SUPERVISOR_PASS, archivo: 'supervisorAuth.json' },
    { rol: 'jefe', email: process.env.JEFE_USER, password: process.env.JEFE_PASS, archivo: 'jefeAuth.json' },
    { rol: 'empleado', email: process.env.EMPLEADO_USER, password: process.env.EMPLEADO_PASS, archivo: 'empleadoAuth.json' },
  ]
